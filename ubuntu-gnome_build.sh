...
# 安装基础软件包
chroot rootdir apt install -y bash-completion sudo apt-utils ssh openssh-server nano initramfs-tools chrony curl wget dnsmasq nftables iproute2 zram-tools ubuntu-desktop
